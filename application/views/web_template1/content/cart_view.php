...
<div class="wrap_root" style="width:1180px">
    <div class="wrap_content" style="height:auto">
        <div class="left" style="width:1180px">
                        ...
                        <table> 
                            ...
                            <tbody> <?php
                                ...
                                <tr> <?php 
                                    ...
                                    <td class="cart_view_input">
                                        <?php 
                                            echo form_input(array('type' => 'number', 'class' => 'cart_qttys', 'id' => 'cart_'.$item['id'].'_qty', 'name' => 'cart['.$item['id'].'][qty]', 'value' => $item['qty'], 'min' => '1', 'max' => '99', 'onchange' => "quantity_change(this.value, ".$item['id'].")")); 
                                        ?>
                                    </td>
            ...
            <div class="order_result" style="display:none">
                <div class="confirm_heading">
                    <h2 align="center">การสั่งซื้อเสร็จสิ้น</h2>
                </div>
                <div class="confirm_view result_view">
                    <table>
...
<script type="text/javascript">
    ...
    function save_info() {
        if ($("#OD_Name").val() == '' || $("#OD_Name").val() == null) {
            ...
            $(".result_view").html($(".confirm_view").html());
        }
    }
